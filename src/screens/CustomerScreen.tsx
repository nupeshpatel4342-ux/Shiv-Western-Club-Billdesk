      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        {activeTab === "home" && (() => {
          if (activeBanners === null) {
            return (
              <div className="w-full h-[250px] md:h-[400px] lg:h-[700px] bg-gray-100 animate-pulse flex items-center justify-center text-gray-400 font-medium">
          ...
          return (
            <div
              className="w-full h-[250px] md:h-[400px] lg:h-[700px] relative overflow-hidden"
